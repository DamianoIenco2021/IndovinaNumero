...
public class FXMLController {
    ...
    @FXML
    void doTentativoProva(ActionEvent event) {

    	//lettura imput utente
    	...
    	{
    		//indovinato
    		txtRisultato.appendText("\nHai Vinto con "+ this.tentativiFatti + " Tentativi!");
    		this.inGioco=false;
    	...
    	//non ha vinto -> devo informare l'utente su la bontà del tentativo
    	if(tentativo<this.segreto) {
